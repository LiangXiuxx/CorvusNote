          ...
          <div className="discover-content">
            ...
            <div className="search-bar">
              ...
              <button className="search-btn">
                <svg t="1770436559967" className="icon" viewBox="0 0 24 24" width="20" height="20"><path d="M9.5 3A6.5 6.5 0 0 1 16 9.5c0 1.61-.59 3.09-1.56 4.23l.27.27h.79l5 5-1.5 1.5-5-5v-.79l-.27-.27A6.516 6.516 0 0 1 9.5 16 6.5 6.5 0 0 1 3 9.5 6.5 6.5 0 0 1 9.5 3m0 2C7 5 5 7 5 9.5S7 14 9.5 14 14 12 14 9.5 12 5 9.5 5z" fill="currentColor"></path></svg>
              </button>
            </div>
              ...
              <div className="left-panel">
                ...
                <div className="kb-info">
                  <button className="back-btn" onClick={handleBackToDiscover}>
                    <svg t="1770436559967" className="icon" viewBox="0 0 24 24" width="20" height="20"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" fill="currentColor"></path></svg>
                    返回
                  </button>
                    ...
                    {knowledgeBaseContent.folders.map(folder => (
                      <div key={folder.id} className="folder-item">
                        <div className="folder-header">
                          <svg t="1770436559967" className="icon" viewBox="0 0 24 24" width="16" height="16"><path d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 12H4V8h5.17L12 10.83V18h8z" fill="currentColor"></path></svg>
                        ...
                        <div className="folder-content">
                          {folder.items && folder.items.map(item => (
                            <div key={item.id} className={`file-item ${selectedFile?.id === item.id ? 'active' : ''}`} onClick={() => item.type === 'file' && handleFileClick(item)}>
                              {item.type === 'folder' ? (
                                <>
                                  <svg t="1770436559967" className="icon" viewBox="0 0 24 24" width="14" height="14"><path d="M20 6h-8l-2-2H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm0 12H4V8h5.17L12 10.83V18h8z" fill="currentColor"></path></svg>
                                  <span className="file-name">{item.name}</span>
                                </>
                              ) : (
                                <>
                                  <svg t="1770436559967" className="icon" viewBox="0 0 24 24" width="14" height="14"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z" fill="currentColor"></path></svg>
                                  <span className="file-name">{item.name}</span>
