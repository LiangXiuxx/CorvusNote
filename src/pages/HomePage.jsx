    ...
    <div className="home-page">
      <div className="side-bar">
        ...
        <div className="nav-items">
          ...
          <div
            className="nav-item"
            data-tooltip={user.isGuest ? '注册后解锁：个人知识库' : '个人知识库'}
            onClick={user.isGuest ? () => alert('注册后即可管理个人知识库，使用 RAG 增强问答') : onGoToKnowledgeBase}
          >
            <span className={`nav-icon${user.isGuest ? ' nav-icon-locked' : ''}`}>
          ...
          <div
            className="nav-item"
            data-tooltip={user.isGuest ? '注册后解锁：发现共享知识库' : '发现'}
            onClick={user.isGuest ? () => alert('注册后即可浏览和使用共享知识库') : onGoToSharedKnowledgeBase}
          >
            <span className={`nav-icon${user.isGuest ? ' nav-icon-locked' : ''}`}>
            ...
            <div className="input-wrapper">
              ...
              <div className="input-actions">
                ...
                <div className="right-actions">
                  ...
                  <button
                    type="button"
                    className={`at-button${user.isGuest ? ' btn-locked' : ''}`}
                    onClick={user.isGuest ? () => alert('注册后即可挂载知识库，享受 RAG 增强问答') : handleAtClick}
                    title={user.isGuest ? '注册后解锁：挂载知识库' : '选择知识库'}
                  >
                    @
                  </button>
